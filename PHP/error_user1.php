...
echo '<h1>Error-Username</h1><br><br>';
echo '<pre>';
echo '<h4>> Username: Must only contain letters, digits and underscore. </h4><br><br><br>';
echo '<a href="register.html"><h4>> Return. </h4></a><br>';
echo '</pre>';
echo '</div>';
echo '</div>';
echo '</body>';
